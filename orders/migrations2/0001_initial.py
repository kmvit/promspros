    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=100, verbose_name='\u041d\u0430\u0437\u0432\u0430\u043d\u0438\u0435 \u043a\u043e\u043c\u043f\u0430\u043d\u0438\u0438', blank=True)),
                ('url', models.CharField(max_length=100, verbose_name='\u0421\u044b\u043b\u043b\u043a\u0430 \u043d\u0430 \u0441\u0430\u0439\u0442', blank=True)),
                ('location', models.CharField(max_length=140, verbose_name='\u0413\u043e\u0440\u043e\u0434', blank=True)),
                ('ur_adress', models.CharField(max_length=300, verbose_name='\u042e\u0440\u0438\u0434\u0438\u0435\u0441\u043a\u0438\u0439 \u0430\u0434\u0440\u0435\u0441', blank=True)),
                ('pochta_adress', models.CharField(max_length=300, verbose_name='\u041f\u043e\u0447\u0442\u043e\u0432\u044b\u0439 \u0430\u0434\u0440\u0435\u0441', blank=True)),
                ('inn', models.CharField(max_length=9, verbose_name='\u0418\u041d\u041d', blank=True)),
                ('bik', models.CharField(max_length=12, verbose_name='\u0411\u0418\u041a', blank=True)),
                ('bank', models.CharField(max_length=200, verbose_name='\u041d\u0430\u0438\u043c\u0435\u043d\u043e\u0432\u0430\u043d\u0438\u0435 \u0431\u0430\u043d\u043a\u0430', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('file', models.FileField(upload_to=b'images/company', null=True, verbose_name='\u0424\u043e\u0442\u043e\u0433\u0440\u0430\u0444\u0438\u0438', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('born', models.DateField(default=django.utils.timezone.now, verbose_name=b'\xd0\x94\xd0\xb5\xd0\xbd\xd1\x8c \xd1\x81\xd0\xbe\xd0\xb7\xd0\xb4\xd0\xb0\xd0\xbd\xd0\xb8\xd1\x8f')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('file', models.FileField(upload_to=b'images/order', null=True, verbose_name='\u0424\u043e\u0442\u043e\u0433\u0440\u0430\u0444\u0438\u0438', blank=True)),
                ('order', models.ForeignKey(verbose_name='\u0424\u043e\u0442\u043e \u0437\u0430\u043a\u0430\u0437\u0430', to='orders.Order')),
            ],
            options={
